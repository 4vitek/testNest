...
let TestsController = class TestsController {
    constructor(testtsService) {
        this.testtsService = testtsService;
    }
    getBooks() {
        return __awaiter(this, void 0, void 0, function* () {
            const tests = yield this.testtsService.getTests();
            return tests;
        });
    }
};
...
], TestsController.prototype, "getBooks", null);
TestsController = __decorate([
    common_1.Controller(routes_1.ApiRoutes.ROUTE_TEST),
